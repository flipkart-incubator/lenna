...
do
    ...
    echo "Restarting service on "${API_HOST}
    ssh ${API_HOST} "sudo /etc/init.d/rukmini stop;rm /var/log/rukmini/rukmini.log;touch /var/log/rukmini/rukmini.log;chmod 777 /var/log/rukmini/rukmini.log;sudo /etc/init.d/rukmini start"
